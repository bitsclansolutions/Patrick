...
import ThirdRightNavBar from "./Component/ThirdRightNavBar/ThirdRightNavBar";
import RightNavBar from "../GroundFloor/Components/RightNavBar";
import StudyRoom from "./Component/StudyRoom/StudyRoom";
import GuestRoom from "./Component/GuestRoom/GuestRoom";
import HallAttic from "./Component/HallAttic/HallAttic";
import StoreRoom from "./Component/StoreRoom/StoreRoom";
import Laundary from "./Component/Laundary/laundary";
...
const Attic = (props) => {
  ...
  const [gamePhase, setGamePhase] = useState("hall");
